 ...
 *
 */
function buildFinal (master, logic_debug, fields, deliverables,outputFile) {
  "use strict";
  ...
  output.push('<div class="col-lg-12 contents">');
    output.push('<div class="well">');
      ...
      output.push('<div id="q-final-var-container" class="var-container form-group">');
        ...
        output.push('</ul>');
      output.push('</div>');
      for (var l = 0; l < outputFile[0].deliverables.length; l++) {
         var deliverable_type = "fa-file-o";
          if (outputFile[0].deliverables[l].type.toUpperCase() === 'PDF' || outputFile[0].deliverables[l].type.toUpperCase() === 'PDF_FORM') { 
            deliverable_type = "fa-file-pdf-o"; 
          } 

          if (outputFile[0].deliverables[l].type.toUpperCase() === 'XML' || outputFile[0].deliverables[l].type.toUpperCase() === 'XML_MSACCESS') {
            deliverable_type = "fa-file-code-o";
          }

          if (outputFile[0].deliverables[l].type.toUpperCase() === 'RTF' || outputFile[0].deliverables[l].type.toUpperCase() === 'ODT') {
            deliverable_type = "fa-file-text-o";
          }

          if (outputFile[0].deliverables[l].type.toUpperCase() === 'DOC' || outputFile[0].deliverables[l].type.toUpperCase() === 'DOCX') {
            deliverable_type = "fa-file-word-o";
          }
          var stringfile='<div class="var-container form-group"><span class="pull-right"><i class="fa ' + deliverable_type + '"></i><a  href="/manager/download/deliverable/output/' + outputFile[0]._doc.id + '/' + outputFile[0]._doc.interview.id + '/' + outputFile[0]._doc.deliverables[l].id + '" target="_blank">' + outputFile[0]._doc.deliverables[l].name + '</a></span></div>';
          output.push('<div>');
            output.push(stringfile);
          output.push('</div>');
      }
      output.push('<div class="row question-footer">');
 ...
 *
 */
exports.final = function (qid, question, data, master, fields, progress, deliverables,outPutFile) {
  "use strict";
  ...
  // put the question and the debug together
  var run_build = buildFinal(after_logic.vars, after_logic.debug.join(""), fields, deliverables,outPutFile);
